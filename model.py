...
from WaveFormer.WaveFormer_dct import WaveFormer
...
class MMDET_VWAVE(BaseModule, WaveFormer):
    def __init__(self, patch_size=4, in_chans=3, num_classes=1000, depths=[2, 2, 9, 2], 
        ...
        vWave.__init__(self, patch_size=patch_size, in_chans=in_chans, num_classes=num_classes, depths=depths, 
...
#         del self.norm
    ...
    def load_pretrained(self, ckpt=""):
        ...
        incompatibleKeys = self.load_state_dict(new_dict, strict=False)
...
class MMSEG_WaveFormer(MMDET_WaveFormer):
    ...
